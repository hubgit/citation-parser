...
B<ParaTools::DocParser> - document parsing framework 

=head1 DESCRIPTION

ParaTools::DocParser provides generic methods that should be overriden
...
class should at least override the get_references method.

=head1 METHODS

=over 4

=item $docparser = ParaTools::DocParser-E<gt>new()
...
The get_references() method takes an array of lines and returns an array
